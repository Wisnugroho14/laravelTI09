    ...
    <div class="col-lg-7">
      <div class="card mt-5">
        <div class="card-body">
          ...
          @endif <br />
          <form action="{{url('hasilprak9')}}" method="post">
            {{csrf_field()}}
            ...
            <div class="form-group row">
              <label for="text2" class="col-4 col-form-label">Lokasi</label>
              <div class="col-8">
                <input id="text2" name="lokasi" type="text" class="form-control" value="{{old('lokasi')}}">
              </div>
            </div>
            <div class="form-group row">
